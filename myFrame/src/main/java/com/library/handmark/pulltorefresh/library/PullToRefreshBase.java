 ...
 *******************************************************************************/
package com.library.handmark.pulltorefresh.library;
...
import com.library.handmark.pulltorefresh.library.internal.FlipLoadingLayout;
import com.library.handmark.pulltorefresh.library.internal.LoadingLayout;
import com.library.handmark.pulltorefresh.library.internal.RotateLoadingLayout;
import com.library.handmark.pulltorefresh.library.internal.Utils;
import com.library.handmark.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final void onRefreshComplete() {
		if (isRefreshing()) {
			getLoadingLayoutProxy().setLastUpdatedLabel(getContext().getString(R.string.pull_refresh_last_update) + 
					DATEFORMAT_YMDHM.format(new Date()));
